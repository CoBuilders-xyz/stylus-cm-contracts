...
export const ARB_WASM_ADDRESSES = {
  arbitrumOne:
    process.env.ARB_ONE_ARB_WASM_ADDRESS ||
    '0x0000000000000000000000000000000000000071',
  arbitrumSepolia:
    process.env.ARB_SEPOLIA_ARB_WASM_ADDRESS ||
    '0x0000000000000000000000000000000000000071',
  localArb:
    process.env.ARB_LOCAL_ARB_WASM_ADDRESS ||
    '0x0000000000000000000000000000000000000071',
  superposition:
    process.env.SUPERPOSITION_ARB_WASM_ADDRESS ||
    '0x0000000000000000000000000000000000000071',
};
